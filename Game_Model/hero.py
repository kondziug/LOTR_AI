...
class Hero(PlayerCreature):
    def __init__(self, id, name, attack, defense, hitpoints, willpower, sphere, threat):
        super(Hero, self).__init__(id, name, attack, defense, hitpoints, willpower, sphere)
        self.threat = threat
        self.resourcePool = 0
    ...
    def copy(self):
        newHero = Hero(self.id, self.name, self.attack, self.defense, self.hitpoints, self.willpower, self.sphere, self.threat)
